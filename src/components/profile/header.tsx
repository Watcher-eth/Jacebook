...
export function ProfileHeader() {
  return (
    <div className="bg-card">
      {/* Cover Photo with overlaid profile info */}
      <div className="relative w-full bg-muted flex justify-center">
        <div className="relative max-w-[1050px] w-full h-[315px]">
          <img src="/medical-illustration-showing-human-spine-and-skele.jpg" alt="Cover" className="w-full h-full object-cover" />
      ...
      <div className="max-w-[1050px] mx-auto px-4 -mt-30">
        <div className="flex items-end gap-4">
          <Avatar className="h-[160px] w-[160px] border-4 -top-2 border-card rounded-none flex-shrink-0">
            <AvatarImage src="/professional-black-and-white-portrait-man-in-suit.jpg" />
            <AvatarFallback className="text-5xl rounded-none">AF</AvatarFallback>
          </Avatar>

          {/* Navigation Tabs next to profile picture */}
